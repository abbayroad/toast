function Toast(x) {
    ...
    if(x.closeBtn) {
        ...
        setTimeout(() => {
            ...
            let minfo = document.querySelector("#info")
            let msuccess = document.querySelector("#success")
            let mwarning = document.querySelector("#warning")
